      ...
      contents: [
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "DHT11 / DHT22 — Humidity + Temperature" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_dht_setup" },
            { kind: "label", text: "▸ Step 2: Read Data" },
            { kind: "block", type: "esp32_dht_get_reading" },
            { kind: "block", type: "esp32_dht" },
            { kind: "label", text: "▸ Step 3: Print to Serial" },
            { kind: "block", type: "esp32_dht_serial_both" },
            { kind: "label", text: "DS18B20 — Waterproof Temperature Probe" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_ds18b20_setup" },
            { kind: "label", text: "▸ Step 2: Read Temperature" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "HC-SR04 — Distance Measuring (2 cm – 4 m)" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_ultrasonic_setup" },
            { kind: "label", text: "▸ Step 2: Read Distance" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "BMP280 — Temperature + Pressure + Altitude" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "PIR Motion Sensor (HC-SR501) — Digital" },
            { kind: "label", text: "▸ Step 1: Read Motion" },
            { kind: "block", type: "esp32_pir_sensor" },
            { kind: "label", text: "▸ Step 2: Useful Outputs & Alerts" },
            { kind: "block", type: "esp32_pir_print_serial" },
            { kind: "block", type: "esp32_pir_alarm" },
            { kind: "label", text: "IR Obstacle Sensor (FC-51) — Digital / Analog" },
            { kind: "label", text: "▸ Step 1: Read Obstacle & Distance" },
            { kind: "block", type: "esp32_ir_sensor" },
            { kind: "block", type: "esp32_ir_sensor_analog" },
            { kind: "block", type: "esp32_ir_sensor_analog_percent" },
            { kind: "label", text: "▸ Step 2: Useful Outputs & Alerts" },
            { kind: "block", type: "esp32_ir_print_serial" },
            { kind: "block", type: "esp32_ir_alarm" },
            { kind: "label", text: "IR Line Tracking Sensor (TCRT5000) — Analog" },
            { kind: "label", text: "▸ Line Following & Detection" },
            { kind: "block", type: "esp32_ir_line_analog" },
            { kind: "block", type: "esp32_ir_line_detected" },
            { kind: "block", type: "esp32_ir_line_print_serial" },
          ]
        },
        {
          kind: "category",
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "MFRC522 — RFID Card Reader (SPI)" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_rfid_setup" },
            { kind: "label", text: "▸ Step 2: Detect Card" },
            { kind: "block", type: "esp32_rfid_card_present" },
            { kind: "label", text: "▸ Step 3: Read Card Data" },
            { kind: "block", type: "esp32_rfid_read_uid" },
            { kind: "label", text: "▸ Step 4: Access Control (UID Match)" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "IR Receiver — Receive signals from remote" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_ir_receiver_setup" },
            { kind: "label", text: "▸ Step 2: Receive Data" },
            { kind: "block", type: "esp32_ir_receiver_available" },
            { kind: "block", type: "esp32_ir_receiver_read" },
            { kind: "label", text: "▸ Step 3: Resume Listening" },
            { kind: "block", type: "esp32_ir_receiver_resume" },
            { kind: "label", text: "IR Sender — Transmit signals to devices" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_ir_sender_setup" },
            { kind: "label", text: "▸ Step 2: Send Code" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "Flame Sensor — Detect fire / infrared light" },
            { kind: "label", text: "▸ Step 1: Read Sensor" },
            { kind: "block", type: "esp32_flame_digital" },
            { kind: "block", type: "esp32_flame_analog" },
            { kind: "label", text: "▸ Step 2: Useful Outputs" },
            { kind: "block", type: "esp32_flame_percent" },
            { kind: "block", type: "esp32_flame_alarm" },
            { kind: "label", text: "MQ-2 Gas / Smoke Sensor — Detect LPG, CO, smoke" },
            { kind: "label", text: "▸ Step 1: Read Sensor" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "Rain Sensor (FC-37 / YL-83) — Detect rainfall" },
            { kind: "label", text: "▸ Step 1: Read Sensor" },
            ...
            { kind: "label", text: "Soil Moisture Sensor — Measure water in soil" },
            { kind: "label", text: "▸ Easy Blocks (Generalized)" },
            { kind: "block", type: "esp32_soil_setup" },
            { kind: "block", type: "esp32_soil_read_moisture" },
            { kind: "block", type: "esp32_soil_is_dry" },
            { kind: "block", type: "esp32_soil_print_serial" },
            { kind: "block", type: "esp32_soil_watering_alert" },
            { kind: "label", text: "▸ Advanced / Raw ADC" },
            { kind: "block", type: "esp32_soil_moisture_analog" },
            { kind: "block", type: "esp32_soil_moisture_digital" },
            { kind: "label", text: "Water Level Sensor — Measure water depth" },
            { kind: "label", text: "▸ Easy Blocks (Generalized)" },
            { kind: "block", type: "esp32_water_setup" },
            { kind: "block", type: "esp32_water_read_level" },
            { kind: "block", type: "esp32_water_is_above" },
            { kind: "block", type: "esp32_water_print_serial" },
            { kind: "block", type: "esp32_water_alert" },
            { kind: "label", text: "▸ Advanced / Raw ADC" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "Sound / Microphone Sensor — Detect noise levels" },
            { kind: "label", text: "▸ Step 1: Read Sensor" },
            ...
            { kind: "label", text: "▸ Raw ADC (Advanced)" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "TTP223 Capacitive Touch — Digital output" },
            { kind: "label", text: "▸ Read Touch Detection" },
            { kind: "block", type: "esp32_touch_sensor" },
            { kind: "label", text: "SW-420 Vibration Sensor — Digital output" },
            { kind: "label", text: "▸ Read Vibration Detection" },
        ...
        },
        {
          ...
          colour: "#ff8c1a",
          contents: [
            { kind: "label", text: "LDR / Photoresistor — Measure ambient light" },
            { kind: "label", text: "▸ Step 1: Read Sensor" },
            ...
            { kind: "label", text: "BH1750 Ambient Light (I2C) — Precise lux reading" },
            { kind: "label", text: "▸ Step 1: Setup (place first)" },
            { kind: "block", type: "esp32_bh1750_setup" },
            { kind: "label", text: "▸ Step 2: Read Light Level" },
        ...
        },
        {
          ...
          contents: [
            ...
            { kind: "label", text: "━━ ⏱ Timed — runs once at start ━━" },
            { kind: "block", type: "esp32_l298n_motor_run_time" },
            { kind: "block", type: "esp32_l298n_turn_left_time" },
            { kind: "block", type: "esp32_l298n_turn_right_time" },
            { kind: "block", type: "esp32_l298n_robot_move_time" },
            { kind: "label", text: "━━ Continuous Motor Control ━━" },
            { kind: "block", type: "esp32_l298n_motor_run" },
            { kind: "block", type: "esp32_l298n_turn_left" },
            { kind: "block", type: "esp32_l298n_turn_right" },
            ...
            { kind: "label", text: "━━ Robot Navigation ━━" },
        ...
        },
        {
          ...
          contents: [
            ...
            { kind: "label", text: "Tachometer (A3144 / 3144) — Count rotations" },
            { kind: "label", text: "▸ Measure Speed" },
