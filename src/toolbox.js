      ...
      contents: [
        ...
        },
        {
          ...
          contents: [
            ...
            { kind: "label", text: "▸ Read Motion Detection" },
            { kind: "block", type: "esp32_pir_sensor" },
            { kind: "label", text: "IR Obstacle Sensor — Digital (OUT/D0 pin)" },
            { kind: "label", text: "▸ Read Obstacle Detected" },
            { kind: "block", type: "esp32_ir_sensor" },
            { kind: "label", text: "IR Obstacle Sensor — Analog (AO/A0 pin)" },
            { kind: "label", text: "▸ Read Distance + Percentage" },
            { kind: "block", type: "esp32_ir_sensor_analog" },
            { kind: "block", type: "esp32_ir_sensor_analog_percent" },
            { kind: "label", text: "IR Line Tracking Sensor — Analog (AO/A0 pin)" },
            { kind: "label", text: "▸ Read Line Detection" },
