...
// ── Universal Field & Dropdown Styling Hook ──────────
if (Blockly.FieldDropdown) {
  const origDropdownApplyColour = Blockly.FieldDropdown.prototype.applyColour;
  Blockly.FieldDropdown.prototype.applyColour = function() {
    if (origDropdownApplyColour) origDropdownApplyColour.call(this);
    if (this.borderRect_) {
      this.borderRect_.setAttribute('fill', '#FFFFFF');
      this.borderRect_.style.fill = '#FFFFFF';
      this.borderRect_.style.stroke = 'rgba(0, 0, 0, 0.25)';
      this.borderRect_.style.strokeWidth = '1px';
    }
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
      this.textElement_.style.fontWeight = '800';
    }
  };

  const origDropdownRender = Blockly.FieldDropdown.prototype.render_;
  Blockly.FieldDropdown.prototype.render_ = function() {
    if (origDropdownRender) origDropdownRender.call(this);
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
...
if (Blockly.FieldTextInput) {
  const origTextApplyColour = Blockly.FieldTextInput.prototype.applyColour;
  Blockly.FieldTextInput.prototype.applyColour = function() {
    if (origTextApplyColour) origTextApplyColour.call(this);
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
  ...
  const origTextRender = Blockly.FieldTextInput.prototype.render_;
  Blockly.FieldTextInput.prototype.render_ = function() {
    if (origTextRender) origTextRender.call(this);
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
...
if (Blockly.FieldNumber) {
  const origNumberApplyColour = Blockly.FieldNumber.prototype.applyColour;
  Blockly.FieldNumber.prototype.applyColour = function() {
    if (origNumberApplyColour) origNumberApplyColour.call(this);
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
  ...
  const origNumberRender = Blockly.FieldNumber.prototype.render_;
  Blockly.FieldNumber.prototype.render_ = function() {
    if (origNumberRender) origNumberRender.call(this);
    if (this.textElement_) {
      this.textElement_.setAttribute('fill', '#0F172A');
      this.textElement_.style.fill = '#0F172A';
      this.textElement_.style.color = '#0F172A';
